	...
	return SettingsPage({
		...
		children = {
			VolumeSettingRow({
				...
				label = "Master Volume",
				description = "Controls every sound in the game.",
				value = props.masterVolume,
				muted = props.masterMuted,
				layoutOrder = 1,
				zIndex = 24,
			}),
			...
			VolumeSettingRow({
				name = "SFXVolumeRow",
				label = "SFX Volume",
				description = "Controls interface and gameplay sounds.",
			...
			VolumeSettingRow({
				name = "MusicVolumeRow",
				label = "Music Volume",
				description = "Controls background music.",
