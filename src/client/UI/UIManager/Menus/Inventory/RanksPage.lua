...
local function RanksPage(props: RanksPageProps)
	return create("CanvasGroup")({
		Name = "RanksInventoryPage",
		...
		Effects.SlideFadeCanvasGroup({
			open = function()
				return props.selectedTab() == "Ranks"
			end,
		...
		create("Frame")({
			...
			Text({
				name = "EmptyText",
				text = "Rank inventory is not added yet.",
